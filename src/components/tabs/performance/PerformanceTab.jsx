...
function computePerformance({ peso, fuel, track, trackCustom, pilots, pneusLib, pneusSession, regs, mechSpecs, setup, temp, profileParts, profileId, vehicleType = 'car' }) {
...
export default function PerformanceTab({ activeProfile, profileParts = [], vehicleType = 'car' }) {
  const isTruck = vehicleType === 'truck';
  const C = useColors();
