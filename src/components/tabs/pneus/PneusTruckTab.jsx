...
// ── Calculadora de pressão fria — Tier 3 (aprende do histórico) ─────────────
function estimateTOpTruck({ tTrackC, compoundType, position }) {
  const t = parseFloat(tTrackC);
  if (isNaN(t)) return null;
  let base = 36; // truck slick típico
  if (compoundType) {
    const k = String(compoundType).toLowerCase();
    if      (k.includes('soft'))   base = 42;
    else if (k.includes('medium')) base = 36;
    else if (k.includes('hard'))   base = 30;
    else if (k.includes('rain') || k.includes('wet')) base = 12;
  }
  const posDelta = position === 'rear' ? 6 : 0; // truck tração traseira: traseiro mais quente
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <div style={theme.card}>
        ...
        {/* Calculadora de Pressão Fria — Tier 3 */}
        {showColdCalc && (() => {
            ...
            <div style={{
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 10, marginBottom: 10 }}>
                <div>
                  ...
                  <input type="number" step="0.1" placeholder="Ex: 9.5"
